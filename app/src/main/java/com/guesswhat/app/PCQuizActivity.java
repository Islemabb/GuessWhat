...
public class PCQuizActivity extends AppCompatActivity {
    ...
    protected String correctAnswer = "MSI";
    protected Class<?> nextActivityClass = PCQuizActivity2.class;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pc_quiz);
        ...
        btnNext.setOnClickListener(v -> {
            if (nextActivityClass != null) {
                Intent intent = new Intent(PCQuizActivity.this, nextActivityClass);
                startActivity(intent);
            } else {
                Intent intent = new Intent(PCQuizActivity.this, CategoryActivity.class);
                startActivity(intent);
            }
            finish();
        });
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(PCQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(PCQuizActivity.this, CategoryActivity.class);
                            startActivity(intent);
