...
public class CarQuizActivity extends AppCompatActivity {

    protected Button btnAnswer1, btnAnswer2, btnAnswer3, btnHint, btnSkip, btnRefill, btnNext;
    protected ImageView heart1, heart2, heart3, carImage;
    private TextView returnText;

    protected String correctAnswer = "AUDI";
    protected Class<?> nextActivityClass = CarQuizActivity2.class;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_quiz);
        ...
        // 👇 Load sound effects from res/raw/correct.mp3 and res/raw/wrong.mp3
        ...
        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(CarQuizActivity.this, nextActivityClass);
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(CarQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                            finish();
                        }
                        break;
    ...
    private void disableButton(Button btn) {
        ...
        btn.setBackgroundColor(Color.parseColor("#A9A9A9")); // grey
    }
    ...
    // 👇 Release players to avoid leaks
    @Override
