...
// Added import for audio
import android.media.MediaPlayer;

public class FamousQuizActivity extends AppCompatActivity {
    ...
    protected String correctAnswer = "ELON MUSK";
    protected Class<?> nextActivityClass = FamousQuizActivity2.class;
    ...
    // Added fields for sound effects
    private MediaPlayer sfxCorrect, sfxWrong;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_famous_quiz);
        ...
        btnNext.setOnClickListener(v -> {
            if (nextActivityClass != null) {
                Intent intent = new Intent(FamousQuizActivity.this, nextActivityClass);
                startActivity(intent);
            } else {
                Intent intent = new Intent(FamousQuizActivity.this, CategoryActivity.class);
                startActivity(intent);
            }
            finish();
        });
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(FamousQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(FamousQuizActivity.this, CategoryActivity.class);
                            startActivity(intent);
    ...
    // Release media players to prevent leaks
    @Override
