...
public class FoodQuizActivity extends AppCompatActivity {
    ...
    protected String correctAnswer = "MCDONALD'S";
    protected Class<?> nextActivityClass = FoodQuizActivity2.class;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            if (nextActivityClass != null) {
                Intent intent = new Intent(FoodQuizActivity.this, nextActivityClass);
                startActivity(intent);
            } else {
                Intent intent = new Intent(FoodQuizActivity.this, CategoryActivity.class);
                startActivity(intent);
            }
            finish();
        });
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(FoodQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(FoodQuizActivity.this, CategoryActivity.class);
                            startActivity(intent);
