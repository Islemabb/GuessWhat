...
public class CompanyQuizActivity extends AppCompatActivity {

    protected Button btnAnswer1, btnAnswer2, btnAnswer3, btnHint, btnSkip, btnRefill, btnNext;
    protected ImageView heart1, heart2, heart3, companyImage;
    ...
    // Added media player fields
    private MediaPlayer sfxCorrect, sfxWrong;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_company_quiz);
        ...
        btnNext.setOnClickListener(v -> {
            if (nextActivityClass != null) {
                Intent intent = new Intent(CompanyQuizActivity.this, nextActivityClass);
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(CompanyQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                            finish();
                        }
                        break;
    ...
    private void disableButton(Button btn) {
        ...
        btn.setBackgroundColor(Color.parseColor("#A9A9A9")); // gray
    }
