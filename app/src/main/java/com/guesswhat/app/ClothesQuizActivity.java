...
public class ClothesQuizActivity extends AppCompatActivity {
    ...
    protected String correctAnswer = "LOUIS VUITTON";
    protected Class<?> nextActivityClass = ClothesQuizActivity2.class;
    ...
    // Added fields for sfx
    private MediaPlayer sfxCorrect, sfxWrong;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_clothes_quiz);
        ...
        btnNext.setOnClickListener(v -> {
            if (nextActivityClass != null) {
                Intent intent = new Intent(ClothesQuizActivity.this, nextActivityClass);
                startActivity(intent);
            } else {
                Intent intent = new Intent(ClothesQuizActivity.this, CategoryActivity.class);
                startActivity(intent);
            }
            finish();
        });
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(ClothesQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(ClothesQuizActivity.this, CategoryActivity.class);
                            startActivity(intent);
