...
public class PhoneQuizActivity extends AppCompatActivity {

    protected Button btnAnswer1, btnAnswer2, btnAnswer3, btnHint, btnSkip, btnRefill, btnNext;
    protected ImageView heart1, heart2, heart3, phoneImage;
    private TextView returnText;

    protected String correctAnswer = "APPLE";
    protected Class<?> nextActivityClass = PhoneQuizActivity2.class;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_quiz);
        ...
        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(PhoneQuizActivity.this, nextActivityClass);
                ...
                switch (currentRewardType) {
                    ...
                    case "skip":
                        if (rewardTargetClass != null) {
                            Intent intent = new Intent(PhoneQuizActivity.this, rewardTargetClass);
                            startActivity(intent);
                            finish();
                        }
                        break;
